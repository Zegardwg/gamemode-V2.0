...
CMD:fmenu(playerid, params[])
{
	...
	if(pData[playerid][pFamily] == -1)
		return ShowNotifError(playerid, "ANDA TIDAK DAPAT MENGAKSES INI", 10000);

	if (!IsPlayerNearPlayer(playerid, userid, 3.0))
	{
		ShowPlayerDialog(playerid, DIALOG_FMENU, DIALOG_STYLE_LIST, "Family Menu" , "Geledah\nIkat\nBuka Ikatan\nSeret\nMasukan Mobil\nKeluarkan Paksa" , "Select" , "Cancel");
	}
