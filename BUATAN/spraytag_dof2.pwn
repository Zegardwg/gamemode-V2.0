/* 
	Spray Tag System criado por NurbWill;
	
	
	Topico: http://forum.sa-mp.com/showthread.php?t=499642
	Versão: 0.2b
	Skype: Nurb.Will
...
#define 	MAX_PLAYERS_TAGS 			(5) 					// Maximo de spray tags criado por player.

#define 	SPRAY_TAG_TIMER 			(4) 					// Segundos para criar a spray tag.
#define 	SPRAY_TAG_OBJECT 			(19353) 				// ID do objeto.
#define 	SPRAY_TAG_OBJECT_DISTANCE 	(200.0) 				// Distância em que pode ser visto a spray tag
...
{
	print("\n--------------------------------------");
	print(" Spray Tag System | Versão: 0.2b - By: Nurb Will;");
	print("--------------------------------------\n");
	return 1;
}
...
public SprayTag_Dialog(iPlayerID, iType)
{
	...
	switch(iType)
	{
		case TYPE_LIST_MENU:
		{
			ShowPlayerDialog(iPlayerID, SPRAYTAG_MENU, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Menu", "Criar spray tag\nEditar spray tag\nDeletar spray tag\nRastrear tag's", "Selecionar", "Sair");
		}
		case TYPE_LIST_CREATE:
		{
			...
			ShowPlayerDialog(iPlayerID, SPRAYTAG_CREATE_MAIN, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Customização", szDialog, "Selecionar", "Voltar");
		}
		case TYPE_LIST_EDIT:
		{
			switch(spraytag_bold[iPlayerID])
			...
			ShowPlayerDialog(iPlayerID, SPRAYTAG_EDIT_LIST, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Customização", szDialog, "Selecionar", "Voltar");
		}
		case TYPE_LIST_TAGS:
		{
			new 
			...
			ShowPlayerDialog(iPlayerID, SPRAYTAG_EDIT_MAIN, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Editar suas tag's", szDialog, "Selecionar", "Voltar");
		}
		case TYPE_LIST_TAGS_DELETE:
		{
			...
			ShowPlayerDialog(iPlayerID, SPRAYTAG_DELETE, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Deletar suas tag's", szDialog, "Selecionar", "Voltar");
		}
		case TYPE_LIST_TAGS_CREATE:
		{
			...
			ShowPlayerDialog(iPlayerID, SPRAYTAG_CREATE, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Selecione um slot livre", szDialog, "Selecionar", "Voltar");
		}
		case TYPE_LIST_TAGS_FIND:
		{
			...
			ShowPlayerDialog(iPlayerID, SPRAYTAG_FIND, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Selecione a tag que você deseja encontrar", szDialog, "Selecionar", "Voltar");
		}
	}
	return 1;
}
...
/*public OnPlayerEnterCheckpoint(playerid)
{
	...
	{
		SendClientMessage(playerid, -1, "Você chegou na sua spray tag.");
	...
	switch(dialogid)
	{
		...
		case SPRAYTAG_EDIT_MAIN:
		{
			...
			if(SprayTags[playerid][listitem][_spPosX] == 0.0)
				return ShowPlayerDialog(playerid, SPRAYTAG_DIALOG_RETURN, DIALOG_STYLE_MSGBOX, "{F7EC6F}Spray Tag - {BD0000} Ops!!", "Ops! Não tem nada nesse slot.", "Okay", "");
		...
		case SPRAYTAG_CREATE:
		{
			...
			} else ShowPlayerDialog(playerid, SPRAYTAG_DIALOG_RETURN, DIALOG_STYLE_MSGBOX, "{F7EC6F}Spray Tag - {BD0000} Ops!!", "Ops! Este slot já está sendo usado.", "Okay", "");
		}
		case SPRAYTAG_EDIT_LIST:
		{
			...
			switch(listitem)
			{
				case 0: ShowPlayerDialog(playerid, SPRAYTAG_EDIT_TEXT, DIALOG_STYLE_INPUT, "{F7EC6F}Spray Tag - {469BF0}Texto", "Digite o texto que você quer que aparece na Spray Tag", "Certo", "Voltar");
				case 1: ShowPlayerDialog(playerid, SPRAYTAG_EDIT_FONT, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Fonte", "Arial\nCourier\nImpact\nPricedown\nDaredevil\nBombing\naaaiight! fat\nFrom Street Art\nGhang\nGraffogie\nGraphers Blog\nNosegrind Demo", "Certo", "Voltar");
				case 2: ShowPlayerDialog(playerid, SPRAYTAG_EDIT_SIZE, DIALOG_STYLE_INPUT, "{F7EC6F}Spray Tag - {469BF0}Tamanho", "Digite o tamanho que você quer que aparece na Spray Tag", "Certo", "Voltar");
				case 3: ShowPlayerDialog(playerid, SPRAYTAG_EDIT_COLOR, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Cor", "{FF0000}Vermelho\n{04B404}Verde\n{00B5CD}Azul Claro\n{FFFF00}Amarelo\n{0000FF}Azul\n{848484}Cinza\n{FF00FF}Rosa\n{FFFFFF}Branco", "Certo", "Voltar");
				case 4: 
				{
		...
		case SPRAYTAG_CREATE_MAIN:
		{
			...
			switch(listitem)
			{
				case 0: ShowPlayerDialog(playerid, SPRAYTAG_CREATE_TEXT, DIALOG_STYLE_INPUT, "{F7EC6F}Spray Tag - {469BF0}Texto", "Digite o texto que você quer que aparece na Spray Tag", "Certo", "Voltar");
				case 1: ShowPlayerDialog(playerid, SPRAYTAG_CREATE_FONT, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Fonte", "Arial\nCourier\nImpact\nPricedown\nDaredevil\nBombing\naaaiight! fat\nFrom Street Art\nGhang\nGraffogie\nGraphers Blog\nNosegrind Demo", "Certo", "Voltar");
				case 2: ShowPlayerDialog(playerid, SPRAYTAG_CREATE_SIZE, DIALOG_STYLE_INPUT, "{F7EC6F}Spray Tag - {469BF0}Tamanho", "Digite o tamanho que você quer que aparece na Spray Tag", "Certo", "Voltar");
				case 3: ShowPlayerDialog(playerid, SPRAYTAG_CREATE_COLOR, DIALOG_STYLE_LIST, "{F7EC6F}Spray Tag - {469BF0}Cor", "{FF0000}Vermelho\n{04B404}Verde\n{00B5CD}Azul Claro\n{FFFF00}Amarelo\n{0000FF}Azul\n{848484}Cinza\n{FF00FF}Rosa\n{FFFFFF}Branco", "Certo", "Voltar");
				case 4: 
				{
					switch(spraytag_bold[playerid])
					{
	...
	if(response == EDIT_RESPONSE_FINAL)
	{
		if(GetPVarInt(playerid, "SPRAYTAG_EDIT") == 1)
		{
			if(!IsPlayerInRangeOfPoint(playerid, 3, x, y, z))
			{
				...
				return SendClientMessage(playerid, -1, "Você não está perto da spray tag.");
			}
...
stock SprayTag_Create(playerid, iIndex)
{
	if(IsPlayerConnected(playerid))
	{
		...
		format(szMessage, sizeof szMessage, "[Spray Tag] Anda akan menemukan tag semprot dengan ID # %i.", iIndex);
		SendClientMessage(playerid, -1, szMessage);
	}
}
...
{
	format(SprayTags[playerid][iIndex][_spText], 50, "Contoh");
...
stock HexToInt22(string[]) // Created by Zamaroth
{
